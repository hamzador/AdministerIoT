...
public class AdminAddNewProductActivity extends AppCompatActivity {
    private String categoryName,prenom,pName,date,saveCurrentDate,saveCurrentTime;
    private Button AddNewProductButton;
    private EditText inputName,inputPrenom, inputDateInscription, inputImage;
...
//        categoryName = getIntent().getExtras().get("category").toString();
       ...
       ProductRef = FirebaseDatabase.getInstance().getReference().child("Personne");

        Toast.makeText(this, categoryName, Toast.LENGTH_SHORT).show();

        AddNewProductButton=findViewById(R.id.add_new_product);
        inputProductImage=findViewById(R.id.select_product_image);
        inputPrenom=findViewById(R.id.product_prenom);
        inputDateInscription=findViewById(R.id.product_date);
    ...
    private void validateProductData(){
        ...
        date=inputDateInscription.getText().toString();
        pName=inputName.getText().toString();
        if(imageUri==null){
            Toast.makeText(this, "Product image is mandatory ...", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(prenom)){
            Toast.makeText(this, "Please write the Laste Name ...", Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(date)){
            Toast.makeText(this, "Please write the date of registration ...", Toast.LENGTH_SHORT).show();
...
//linck of product image  //on peut enlevé getLAstPhathSegent
   ...
   /* private boolean checkPermission() {
    ...
    private void saveProductInfoToDatabase()
    {
        ...
        productMap.put("id_Personne", productRandomKey);//pid = product ID
        productMap.put("dateInscription", saveCurrentDate);
        productMap.put("time", saveCurrentTime);
        productMap.put("prenom", prenom);
        productMap.put("id_Carte", productRandomKey);
...
//dans le viedo les 2 sont inversé
                            ...
                            Intent myIntent =new Intent(AdminAddNewProductActivity.this,HomeActivity.class);
